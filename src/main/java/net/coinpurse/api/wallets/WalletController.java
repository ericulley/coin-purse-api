...
//            }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<String> updateWallet(@PathVariable String id, @RequestBody Wallet newAmount) {
        try {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<String> deleteWalletEntry(@PathVariable String id) {
        try {
